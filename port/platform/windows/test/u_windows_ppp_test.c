...
/** @file
 * @brief Tests that native Windows sockets API to test the
 * PPP-level integration of ubxlib into Windows.  These tests should
 * pass on Windows when there is a cellular module connected.
 ...
 */
#define U_TEST_PREFIX "U_WINDOWS_SOCK_TEST: "
...
/** Basic TCP test.
 */
U_PORT_TEST_FUNCTION("[windowsSock]", "windowsSockTcp")
{
    uNetworkTestList_t *pList;
 ...
 */
U_PORT_TEST_FUNCTION("[windowsSock]", "windowsSockCleanUp")
{
