...
/** @file
 * @brief Tests that native Linux sockets API to test the
 * PPP-level integration of ubxlib into Linux.  These tests should
 * pass on Linux when there is a cellular module connected.
...
/** Basic TCP test.
 */
U_PORT_TEST_FUNCTION("[linuxSock]", "linuxSockTcp")
{
    uNetworkTestList_t *pList;
 ...
 */
U_PORT_TEST_FUNCTION("[linuxSock]", "linuxSockCleanUp")
{
